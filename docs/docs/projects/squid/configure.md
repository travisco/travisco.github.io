...
**Type**: Task <br />
**Components**: Fabric - Windows, Operations <br />
**IMS Environment**: Commercial or FED <br />
**Service Account Name(s)**: (please adjust to any approved format, these are merely suggestions) <br />
<br />
cosuategress <br />
cosdpegress <br />
cosmapiegress <br />
...
coscicdegres <br />
<br />
**Purpose**: Accounts Needed for FS Cloud Egress Proxy Authentication. <br />
**Manager Approval**: Robert Cabrera / Florin Herescu <br />
**Email Distribution list for notifications, in RFC Standard format**: ibm_cos_datapath@wwpdl.vnet.ibm.com <br />
**Department**: IBM COS <br />
...
**Type**: Explicit Proxy- WDC <br />
**IP**: 172.23.197.176 <br />
**Port**: 443 <br />
<br />
<br />
**Type**: Explicit Proxy- MON <br />
**IP**: 172.26.165.155 <br />
**Port**: 443 <br />
...
Verify no proxy is currently set, if one is please consult with the system administrators.
...
Once you have your user added to the AD groups, this is for passwords without special characters. 
...
If your password has special characters, literal backslash characters (\) is need to be escape the character, as shown below.
...
Your proxy should now be setup, you can test this with
```bash
wget google.com
...
You should see it go through your new proxy IP address. 
